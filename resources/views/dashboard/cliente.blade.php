            ...
            <div class="col-lg-2 col-md-4 col-sm-6">
                    <a class="card card-custom card-icon mb-4" href="/empresa">
                        <div class="card-body text-center"><i class="i-Post-Office"></i>
                            ...
                            <p class="text-primary text-24 line-height-1 m-0"><?php echo $empresacliente; ?></p>
                        </div>
                    </a>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <a class="card card-custom card-icon mb-4" href="/aprovacoes/empresas">
                        <div class="card-body text-center"><i class="i-Check"></i>
                            ...
                            <p class="text-primary text-24 line-height-1 m-0"><?php echo $empresaclientependente; ?></p>
                        </div>
                    </a>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-6">
                ...
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <a class="card card-custom card-icon mb-4" href="/empresa/vinculo">
                        <div class="card-body text-center"><i class="i-Add-User"></i>
                            <p class="text-muted mt-2 mb-2">Solicitar Vínculo</p>
                            <p class="text-primary text-24 line-height-1 m-0">+</p>
                        </div>
                    </a>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <a class="card card-custom card-icon mb-4" href="/minha-conta/<?php echo $_SESSION['id'];?>">
                        <div class="card-body text-center"><i class="i-Business-Man"></i>
                            <p class="text-muted mt-2 mb-2">Minha Conta</p>
                            <p class="text-primary text-24 line-height-1 m-0">+</p>
                        </div>
                    </a>
                </div>
